...
class TestStringMethods(unittest.TestCase):
    ...
    def test_is_upper(self):
        ...
        string_val = transform.to_upper_case("hello") # Corrected variable name from sting to string_val
        self.assertEqual(string_val, "HELLO")

    def test_is_lower(self):
        """Test that the to_lower_case function correctly converts a string to lowercase."""
        string_val = transform.to_lower_case("HELLO") # Corrected variable name from sting to string_val
        self.assertEqual(string_val, "hello")

    def test_is_capitalize(self):
        """Test that the to_capitalize function correctly capitalizes a string."""
        string_val = transform.to_capitalize("HELLO") # Corrected variable name from sting to string_val
        self.assertEqual(string_val, "Hello")
